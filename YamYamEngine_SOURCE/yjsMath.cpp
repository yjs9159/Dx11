...
namespace yjs::math
{
	...
	****************************************************************************/
	...
	RECT Rectangle::Intersect(const RECT& rcta, const RECT& rctb) noexcept
	{
	...
	RECT Rectangle::Union(const RECT& rcta, const RECT& rctb) noexcept
	{
		RECT result;
	...
	Vector3 Matrix::ToEuler() const noexcept
	{
	...
	Matrix Matrix::CreateFromAxisAngle(const Vector3& axis, float angle) noexcept
	{
		using namespace DirectX;
		Matrix R;
	...
	Matrix Matrix::CreatePerspectiveFieldOfViewRH(float fov, float aspectRatio, float nearPlane, float farPlane) noexcept
	{
		using namespace DirectX;
		Matrix R;
	...
	Matrix Matrix::CreatePerspectiveRH(float width, float height, float nearPlane, float farPlane) noexcept
	{
		using namespace DirectX;
		Matrix R;
	...
	Matrix Matrix::CreatePerspectiveFieldOfViewLH(float fov, float aspectRatio, float nearPlane, float farPlane) noexcept
	{
		using namespace DirectX;
		Matrix L;
	...
	Matrix Matrix::CreatePerspectiveLH(float width, float height, float nearPlane, float farPlane) noexcept
	{
		using namespace DirectX;
		Matrix L;
	...
	Matrix Matrix::CreatePerspectiveOffCenter(float left, float right, float bottom, float top, float nearPlane, float farPlane) noexcept
	{
		using namespace DirectX;
		Matrix R;
	...
	Matrix Matrix::CreateOrthographicRH(float width, float height, float zNearPlane, float zFarPlane) noexcept
	{
		using namespace DirectX;
		Matrix R;
	...
	Matrix Matrix::CreateOrthographicOffCenterRH(float left, float right, float bottom, float top, float zNearPlane, float zFarPlane) noexcept
	{
		using namespace DirectX;
		Matrix R;
	...
	Matrix Matrix::CreateOrthographicLH(float width, float height, float zNearPlane, float zFarPlane) noexcept
	{
		using namespace DirectX;
		Matrix R;
	...
	Matrix Matrix::CreateOrthographicOffCenterLH(float left, float right, float bottom, float top, float zNearPlane, float zFarPlane) noexcept
	{
		using namespace DirectX;
		Matrix R;
	...
	Matrix Matrix::CreateLookAtRH(const Vector3& eye, const Vector3& target, const Vector3& up) noexcept
	{
		using namespace DirectX;
		Matrix R;
	...
	Matrix Matrix::CreateLookAtLH(const Vector3& eye, const Vector3& target, const Vector3& up) noexcept
	{
		using namespace DirectX;
		Matrix R;
		const XMVECTOR eyev = XMLoadFloat3(&eye);
	...
	Matrix Matrix::CreateFromYawPitchRoll(const Vector3& angles) noexcept
	{
		using namespace DirectX;
		Matrix R;
	...
	bool Ray::Intersects(const BoundingBox& box, _Out_ float& Dist) const noexcept
	{
	...
	Viewport& Viewport::operator= (const RECT& rct) noexcept
	{
...
#if defined(__d3d11_h__) || defined(__d3d11_x_h__)
	Viewport& Viewport::operator= (const D3D11_VIEWPORT& vp) noexcept
	{
...
#if defined(__d3d12_h__) || defined(__d3d12_x_h__) || defined(__XBOX_D3D12_X__)
	Viewport& Viewport::operator= (const D3D12_VIEWPORT& vp) noexcept
	{
		x = vp.TopLeftX; y = vp.TopLeftY;
		width = vp.Width; height = vp.Height;
		minDepth = vp.MinDepth; maxDepth = vp.MaxDepth;
